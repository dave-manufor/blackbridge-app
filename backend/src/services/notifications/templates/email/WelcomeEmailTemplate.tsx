  ...
  return (
    <GenericContentWrapper preview="Start sending files safely with end-to-end encryption.">
      <Container className="w-full px-6">
        ...
        <Text>
          I started BlackBridge with one simple goal: to make file sharing private, seamless, and trustworthy. No friction, no worries about
          who&apos;s looking at your data—just fast, secure transfers you can rely on.
        </Text>
