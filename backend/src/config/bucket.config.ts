export default {
  ...
  /**Storage provider to use (aws or cloudflare) */
  STORAGE_PROVIDER: process.env.STORAGE_PROVIDER || 'aws',
  /**AWS/Cloudflare S3 endpoint URL */
  ...
  STORAGE_CDN_PRIVATE_KEY: process.env.STORAGE_CDN_PRIVATE_KEY ? process.env.STORAGE_CDN_PRIVATE_KEY.replace(/\\n/g, '\n') : undefined,
